...
int main(int argc, char* argv[])
{
    ...
    std::cout << "2. Testing nested function calls...\n";
    outer_function();

    std::cout << "3. Testing recursive calls...\n";
    recursive_fibonacci(8);

    std::cout << "4. Testing functions with multiple scopes...\n";
    function_with_scopes();

    std::cout << "5. Testing async operations...\n";
    test_async_operations();

    std::cout << "6. Testing multithreading...\n";
    test_multithreading();

    std::cout << "7. Testing combined scenario (threads + recursion + nesting)...\n";
